...
This produces `java25-events-1.0.0.jar` in the `target/` directory.
...
```xml
<dependency>
    <groupId>com.joancomasfdz.java25.events</groupId>
    <artifactId>java25-events</artifactId>
    <version>1.0.0</version>
    <scope>system</scope>
    <systemPath>${project.basedir}/../java25.events/target/java25-events-1.0.0.jar</systemPath>
</dependency>
```
