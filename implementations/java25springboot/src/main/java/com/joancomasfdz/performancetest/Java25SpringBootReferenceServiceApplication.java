...
/**
 * Main application class for the Java 25 Spring Boot Reference Service.
...
public class Java25SpringBootReferenceServiceApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(Java25SpringBootReferenceServiceApplication.class, args);
    }
}
