...
public class RabbitConfig {
    ...
    /**
     * Prefetch count for RabbitMQ consumer, configured via application.yml.
     ...
     */
    public static final String QUEUE_NAME = "javaSBGraal";
     ...
     * failures. The prefetch count of 50 limits the number of unacknowledged messages
     * that can be outstanding on the channel, providing better flow control.</p>
     *
